...
import { PhysicianUser } from './physicianuser.entity';
...
export class AppUserService {
    ...
    async newFromParsedJson(jsonAppUser: any): Promise<AppUser> {
        let newAu;
        if (jsonAppUser.type == 'ClinicalSiteUser') {
            if (!jsonAppUser.clinicalSiteId) {
                throw new HttpException('clinicalSiteId missing!', HttpStatus.INTERNAL_SERVER_ERROR);
            }
            ...
            if (!jsonAppUser.sponsorId) {
                throw new HttpException('sponsorId missing!', HttpStatus.INTERNAL_SERVER_ERROR);
            }
